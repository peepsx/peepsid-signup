        ...
        return (
            <Modal closeIcon size='mini' dimmer='blurring' open={this.state.open} onClose={this.close}>
                <Modal.Content>
                    ...
                    <br /><br />
                    The account, <Label>{checkout.accountName}</Label>, will be assigned after payment. Once confirmed, <a href={`${config_master.nameLookup}/${checkout.accountName}`} target="_blank">view your name on the ARISEN blockchain here</a>.
                    <br /><br /><br />
